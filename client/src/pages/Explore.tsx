    ...
    <div className="min-h-screen pt-12 pb-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto mb-16 text-center">
          ...
          <p className="text-lg text-muted-foreground">Discover curated investment opportunities in art and music.</p>
        </div>
        ...
        <div className="bg-card/50 border border-white/10 rounded-2xl p-4 mb-12 backdrop-blur-sm sticky top-20 z-40">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2 w-full md:w-auto">
              ...
              <Select onValueChange={(val) => setFilters(prev => ({ ...prev, riskLevel: val === 'all' ? undefined : val as any }))}>
                <SelectTrigger className="w-[140px] bg-background/50 border-white/10">
              ...
              <Button variant="outline" className="border-white/10 bg-background/50" onClick={() => setFilters({})}>
                Reset
              </Button>
            </div>
          </div>
