          ...
          <Card className="h-full bg-card/50 border-white/5 backdrop-blur-sm overflow-hidden hover:border-primary/50 transition-colors group">
            ...
            <div className="relative aspect-[4/3] overflow-hidden">
              ...
              <div className="absolute top-3 left-3 z-20">
                <Badge variant="secondary" className="backdrop-blur-md bg-white/10 border-white/20 text-white hover:bg-white/20">
                  {asset.type === 'art' ? <Palette className="w-3 h-3 mr-1" /> : <Music className="w-3 h-3 mr-1" />}
              ...
              <div className="absolute bottom-3 left-3 right-3 z-20 flex justify-between items-end">
                <div>
                  <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold mb-1">{asset.returnType} Return</p>
                  <h3 className="text-lg font-bold font-display leading-tight">{asset.name}</h3>
                </div>
              </div>
            </div>
            ...
            <CardContent className="p-4 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold text-primary">{asset.targetReturn}</p>
                </div>
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="capitalize text-sm font-medium">{asset.riskLevel}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-white/5 flex justify-between items-center text-sm">
                ...
                <span className="font-mono font-medium">${asset.minInvestment}</span>
              </div>
            </CardContent>
